...
// Provides control com.myorg.reuselib.Example.
...
/**
 * Constructor for a new <code>com.myorg.reuselib.Example</code> control.
 *
 ...
 * @constructor
 * @public
 * @name com.myorg.reuselib.Example
 */
export default class Example extends Control {
	...
	static readonly metadata = {
		...
		properties: {
			 ...
			 */
			color: {
				type: "com.myorg.reuselib.ExampleColor",
				group: "Appearance",
